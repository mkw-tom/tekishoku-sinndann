		...
		<section className="w-full lg:w-8/12 h-lvh mx-auto ">
			<div className="flex flex-col w-11/12 my-20 gap-10 mx-auto">
				<div className="text-center py-2 w-full mx-auto">
					<h1 className="text-4xl md:text-5xl font-mono tracking-wider mx-auto font-bold flex items-center justify-center gap-3 md:gap-5">
						<span className="text-base-100 tracking-widest ">MBTI適職診断</span>
					</h1>
					<p className="text-md md:text-2xl mx-auto mt-5 text-base-100">
